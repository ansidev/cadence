...
//
//	mockgen -package=metrics -destination=scope_mock.go -self_package=github.com/uber/cadence/common/metrics github.com/uber/cadence/common/metrics Scope
//
...
func (m *MockScope) AddCounter(counter MetricIdx, delta int64) {
	m.ctrl.T.Helper()
...
func (m *MockScope) ExponentialHistogram(hist MetricIdx, d time.Duration) {
	m.ctrl.T.Helper()
...
func (m *MockScope) IncCounter(counter MetricIdx) {
	m.ctrl.T.Helper()
...
func (m *MockScope) IntExponentialHistogram(hist MetricIdx, value int) {
	m.ctrl.T.Helper()
...
func (m *MockScope) RecordHistogramDuration(timer MetricIdx, d time.Duration) {
	m.ctrl.T.Helper()
...
func (m *MockScope) RecordHistogramValue(timer MetricIdx, value float64) {
	m.ctrl.T.Helper()
...
func (m *MockScope) RecordTimer(timer MetricIdx, d time.Duration) {
	m.ctrl.T.Helper()
...
func (m *MockScope) StartTimer(timer MetricIdx) Stopwatch {
	m.ctrl.T.Helper()
...
func (m *MockScope) UpdateGauge(gauge MetricIdx, value float64) {
	m.ctrl.T.Helper()
